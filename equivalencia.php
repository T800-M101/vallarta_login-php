...
<body>
	...
	<option value="predictamen">Predictamen</option></option></select></form>
	...
	<?php
     ...
     $query = "SELECT info.matricula, info.a_paterno, info.a_materno,info.nombre, esco.grado,esco.turno,direc.celular,docu.equivalencia FROM informacion_personal info  INNER JOIN escolaridad esco ON info.matricula = esco.matricula INNER JOIN direcciones direc ON  info.matricula= direc.matricula INNER JOIN documentos docu ON info.matricula = docu.matricula WHERE docu.equivalencia ='$copia' || docu.equivalencia='$pendiente'";
